webpackJsonp([3,8,12,14,22,24,52,54],{
...
exports.create = exports.Item = exports.default = undefined;
...
var Form = (_temp = _class = function (_PureComponent) {
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: (0, _classnames2.default)(_const.CLASS_PREFIX + "-form", this.props.cs) },
        this.props.children
      );
    }
  }]);
  ...
  return Form;
}(_react.PureComponent), _class.isForm = true, _class.create = _create2.default, _class.propTypes = {
  cs: _propTypes2.default.oneOfType([//指定容器class
  _propTypes2.default.string, _propTypes2.default.object])
}, _temp);
exports.default = Form;
var Item = exports.Item = _item2.default;
var create = exports.create = _create2.default;
;
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(Form, "Form", "F:/web/PersonalSite/web/src/libs/components/form/index.js");

  __REACT_HOT_LOADER__.register(Item, "Item", "F:/web/PersonalSite/web/src/libs/components/form/index.js");

  __REACT_HOT_LOADER__.register(create, "create", "F:/web/PersonalSite/web/src/libs/components/form/index.js");
}();
